...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="margin: 20px 20px; border: 1px solid #4090fd;">
        <div style="text-align: center; border-bottom: 1px solid #4090fd;">
            ...
            <asp:Label ID="lblHeader" runat="server" Text="Manage Subjects Information" Font-Size="18"
                        ...
                        <div>
                            <asp:Panel ID="AddNewSubject" runat="server">
                                <asp:TextBox ID="tbNewSubjectLine" placeholder="Add New Subject Info" ValidationGroup="text"
                                    runat="server" tyle="padding-left: 20px;  padding-right: 20px;" Style="width: 30%;
                                    height: 25px; background-color: #e5eef6;" Width="150px" onkeyup="OnsearchtextChanged();"
                    ...
                    <td colspan="3">
                        ...
                        <div id="GroupDetails" runat="server" width="100%" style="border: 1px solid #4090fd;">
                            <asp:GridView ID="GridSubjectDetail" runat="server" Width="100%" AllowPaging="True"
                                ...
                                OnRowUpdating="GridSubjectDetail_RowUpdating" 
                                OnRowDataBound="GridSubjectDetail_RowDataBound" PageSize="20">
