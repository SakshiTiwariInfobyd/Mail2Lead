...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="margin: 20px 20px; border: 1px solid #4090fd;">
        <div style="text-align: center; border-bottom: 1px solid #4090fd;">
            ...
            <asp:Label ID="lblHeader" runat="server" Text="Manage CRM Lead Header Information"
                        ...
                        <div>
                            <asp:Panel ID="Panel1" DefaultButton="btnSearch" runat="server">
                                <asp:TextBox ID="txtSearchBox" placeholder="Search here" runat="server" Style="padding-left: 20px;
                                    padding-right: 20px; width: 200px; height: 25px; background-color:#e5eef6;" Width="150px" MaxLength="50"
                                    CssClass="form-control"  BorderColor="#bbd3e9" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="imgBtnNewLeadInfo" runat="server" Text="Add" CssClass="btn" EnableViewState="false"
                                                ...
                                                OnClick="imgBtnNewLeadInfo_Click" BackColor="#3E75CD" ForeColor="White" />
                                            <asp:Button ID="imgBtnNewLeadInfoCancel" runat="server" Text="Cancel" CssClass="btn"
                                                ...
                                                OnClick="imgBtnNewLeadInfoCancel_Click" BackColor="#3E75CD" 
                                                ForeColor="White" />
                    ...
                    <td colspan="3">
                        ...
                        <div id="GroupDetails" runat="server" width="100%" style="border: 1px solid #4090fd;">
                            <asp:GridView ID="GridLeadDetail" runat="server" Width="100%" AllowPaging="True"
                                ...
                                OnRowDataBound="GridLeadDetail_RowDataBound" PageSize="20">
                                ...
                                <Columns>
                                    ...
                                    <asp:CommandField ButtonType="Image" EditImageUrl="~/Images/edit.png" CancelImageUrl="~/Images/cancel_new.png"
                                        ...
                                        ShowDeleteButton="true" ShowEditButton="true" ItemStyle-Width="50" ItemStyle-HorizontalAlign="Right" HeaderText ="Action">
