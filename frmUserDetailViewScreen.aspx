...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
    <div style="margin: 20px 20px; border: 1px solid #4090fd;">
        <div style="text-align: center; border-bottom: 1px solid #4090fd;">
            <div style="min-width: 550px; margin: 10px auto; padding-bottom: 30px; width: 653px;
                height: 68px;">
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="style7">
                        ...
                        <table style="align: Left; height: 176px; width: 488px;" cellpadding="5" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <div class="col-md-12">
                                    <asp:TextBox runat="server" ID="tbPassword"  CssClass="form-control"
                                        TextMode="Password" />
                                ...
                                <td align="center">
                                    <div id="UpdateDiv" visible="false" runat="server">
                                        <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn" EnableViewState="false"
                                            Width="125" CausesValidation="false"  OnClick="btnUpdate_Click1" />
                                        <asp:Button ID="btnUpdateCancel" runat="server" Text="Cancel" CssClass="btn" Width="125"
                                            CausesValidation="true" OnClick="btnSaveCancel_Click" />
                                    </div>
